    ...
    return (
        <div className="cil-relative cil-inline-block cil-text-left" ref={containerRef}>
            <button
                ...
                aria-label="App Grid"
            >
                <TbGridDots className="cil-w-6 cil-h-6" />
            </button>
            ...
            {isOpen && (
                ...
                >
                    <div className="cil-grid cil-grid-cols-3 cil-gap-3">
                        {apps.map((app) => (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        backgroundColor: getRandomColor(app.appKey),
                                        filter: 'brightness(1.1) grayscale(0.2)' // Adjusted for white icons feeling
                                    }}
                                >
                                    <span className="cil-filter cil-brightness-0 cil-invert">
                                ...
                                {/* Tooltip */}
                                <div className="cil-absolute cil--bottom-10 cil-left-1/2 cil--translate-x-1/2 cil-px-2 cil-py-1 cil-bg-gray-900 cil-text-white cil-text-[10px] cil-rounded-md cil-opacity-0 cil-group-hover:opacity-100 cil-transition-opacity cil-pointer-events-none cil-whitespace-nowrap cil-z-[60] cil-shadow-xl">
                                    {app.appName}
                        ...
                        {apps.length === 0 && (
                            <div className="cil-col-span-3 cil-py-8 cil-text-center cil-text-gray-400 cil-text-sm">
                                {t.noApps}
                            </div>
                        )}
                    </div>
